...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-gray-900 text-sm text-gray-400 border-t border-gray-700 max-w-screen mx-full">
            ...
            <div className="flex items-center justify-center pb-4 mr-4">
              <div className="flex items-center">
                ...
                <h1 className="text-sm font-bold text-blue-400">
                  Learnif<span className="text-blue-500">AI</span>
                </h1>
              </div>
            </div>
          </div>
      ...
      <div className="border-t border-gray-700 mt-6 py-4 px-4 flex flex-col md:flex-row items-center justify-between text-xs text-gray-500 max-w-7xl mx-auto">
        <p>
          © 2025 <span className="text-blue-500 cursor-pointer" onClick={scrollToTop}>LearnifAI</span>. All rights reserved.
        </p>
